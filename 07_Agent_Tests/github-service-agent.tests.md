...
Expect: reacquires fresh PR/head evidence, invokes `draft-pr-created` through
#1022/#1023/#1038, applies only managed delta, preserves unmanaged labels,
rereads for convergence, and separates creation from reconciliation evidence.
...
## Test 13 - Python Repository Implementation
...
## Test 14 - TypeScript / Frontend Repository Implementation
...
## Test 16 - Apps Script Repository Implementation
...
## Test 17 - Integration Repository Implementation
...
## Test 18 - External Workspace Operation Boundary
...
## Test 19 - Cloud Build / Provider Code
...
## Test 20 - Canonical Technical Agent Count
