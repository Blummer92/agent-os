...
- [ ] Preserve the canonical base report evidence fields when the task requires
      machine-checkable/report output.
...
- [ ] Distinguish verified, inferred, proposed, blocked, and completed claims
      when material.
...
- [ ] Omits required base report evidence from a governance-gated report.
