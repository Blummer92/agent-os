...
how an already-required validation should be satisfied: governed pre-PR runtime,
authoritative exact-head CI, explicit manual fallback, or needs-decision.
"""
...
class ValidationRoutePreference:
    ...
    def __post_init__(self) -> None:
        ...
        for name in ("manual_fallback_justified", "duplicate_aggregate_avoided"):
