...
- Repo cleanup (PR 2 of 3): documented `08_Tooling/workflow-scheduler/` in `CLAUDE.md`'s `08_Tooling/` Contents list. Short, factual entry only; no scheduler docs rewritten.
