...
| Workspace Automation Builder Tooling | 0.1.2 |
...
JSON schemas, validation fixtures, reusable local validation helpers, and a local
validation CLI. It does not authorize live Workspace, Notion, trigger, sharing,
