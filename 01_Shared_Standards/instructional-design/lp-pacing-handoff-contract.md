...
`04_Registry/lp-pacing-handoff-contract.yaml` owns serialized field names, ordering, bounds, and stable references; this file and `01_Shared_Standards/instructional-design/lp-pacing-handoff-adaptation.md` own normative meaning.
