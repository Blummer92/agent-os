...
`assessment-cross-unit-validation-standard.md` to verify the same architecture
across Photography, Typography, Graphic Design, Branding, Video Production, and
AI Media from supplied synthetic target/claim/evidence context rather than domain-name defaults.
...
- `assessment-cross-unit-validation-standard.md` — #846 synthetic/noncanonical portability and regression contract across representative Digital Media content domains
