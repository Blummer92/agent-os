...
1. opener or do-now
2. lesson focus or objective
3. model or worked example
4. guided practice
5. discussion or partner talk
6. independent task
7. close, exit task, or reflection
...
purpose, or user request clearly requires a different structure or density.
