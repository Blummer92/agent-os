...
def _task():
    return Task(id="bug-1744", workflow_id="w", type="write", owner="system", action="write:github", idempotency_key="bug-1744", payload={"action": "add_pr_label", "repository_full_name": "Blummer92/agent-os", "pr_number": 1, "label": "type:bug"})
