...
export function App() {
  ...
  const openReady = () => {
    ...
    const result = runReadyPreflight(reviewedTutorial, tutorial0PromptCards, TUTORIAL0_READY_CONTEXT);
