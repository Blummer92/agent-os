...
import { tutorial0CurrentReferencePromptCards, tutorial0ReviewedTutorial } from './fixtures/tutorial0-prompts';
...
export function App() {
  ...
  const openReady = () => {
    ...
    const result = runReadyPreflight(reviewedTutorial, tutorial0CurrentReferencePromptCards, TUTORIAL0_READY_CONTEXT);
