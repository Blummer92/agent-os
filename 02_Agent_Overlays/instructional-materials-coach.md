...
- `01_Shared_Standards/curriculum/curriculum-vocabulary-planner-response-standard.md`
...
- 0.4.6 inherits the curriculum vocabulary planner response standard for vocabulary-sensitive material review.
