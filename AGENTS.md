...
documentation searches. Aliases are optional navigation shortcuts. Agents must
follow the alias constraints defined in the registry. If an alias conflicts with
repository structure, agents must stop and report the conflict.
