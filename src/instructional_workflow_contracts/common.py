...
_REASON_RE = re.compile(
    r"^(?:source|identity|ownership|readiness|authority|handoff|dependency|routing|manual-review|material|artifact|asset|template|destination|quality|lp)-[a-z0-9][a-z0-9._-]{0,110}$"
)
