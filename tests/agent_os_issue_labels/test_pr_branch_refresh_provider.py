...
def test_rebase_preparation_then_expected_head_transport_updates_once():
    ...
    assert runner.calls[3][2]["GIT_AUTHOR_NAME"] == "Agent OS Branch Refresh"
    assert runner.calls[3][2]["GIT_AUTHOR_EMAIL"] == "agent-os-branch-refresh@localhost"
    assert runner.calls[3][2]["GIT_COMMITTER_NAME"] == "Agent OS Branch Refresh"
    assert runner.calls[3][2]["GIT_COMMITTER_EMAIL"] == "agent-os-branch-refresh@localhost"
