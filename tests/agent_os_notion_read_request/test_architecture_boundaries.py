...
def test_single_credential_vocabulary_is_reused() -> None:
    ...
    for module in MODULES:
        ...
        for competing in ("NOTION_API_KEY", "NOTION_SECRET", "NOTION_READONLY_TOKEN_2", "AGENT_OS_NOTION_TOKEN"):
...
def test_shipped_catalog_contains_no_notion_identity() -> None:
    ...
    for lead in ("da5cba48-50fd-4377-9790-8df8f6f2c7dd", "c5b202aa-83d1-4cc4-9992-f98af648e461", "f7f22d33-e1ef-4932-b294-cbe39b24a39a"):
