...
# Public decision functions whose runtime reachability is part of the #2137/#2189
# continuation contract. A function may be consumed by a production composition
# seam or by an explicitly registered runtime entry point; test-only references
# never satisfy the invariant.
