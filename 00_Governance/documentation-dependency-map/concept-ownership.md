...
| Aliases | `navigation-registry-data-model.md`; `04_Registry/legacy-agent-alias-registry.md` | ChatGPT Orchestrator | Medium | data model or registry for data |
| Connector framework | `connector-adapter-framework.md` | ChatGPT Orchestrator | High | connector framework only |
| Workspace discovery | `workspace-discovery-service.md` | ChatGPT Orchestrator | Medium | discovery service doc |
| Notion navigation | `notion-navigation-index-standard.md` | ChatGPT Orchestrator | Medium | Notion standard or client docs |
| Drive navigation | navigation standards + future Drive adapter spec | ChatGPT Orchestrator | Medium | adapter spec, not new core model |
| GitHub navigation | navigation standards + `02_Agent_Overlays/github-service-agent.md` | ChatGPT Orchestrator / GitHub Service Agent | Medium | routing standard; repository implementation in GitHub overlay |
...
| Agent handoffs | `03_Templates/prompts/github-change-request.md` (GitHub); future handoff standard if approved | GitHub Service Agent / ChatGPT Orchestrator | Medium | shared handoff standard if a gap remains |
...
| Visual assets / Prompt Library | Notion working knowledge unless promoted; Issue #97 dependency | Instructional Materials Coach / ChatGPT Orchestrator | Medium | Notion handoff or registry metadata, not GitHub content storage |
| DMSC integration | Issue #97 dependency until an adapter contract exists | ChatGPT Orchestrator | Medium | adapter/dependency spec; separate-repo changes need a separate request |

Repository implementation of registry, navigation, connector, or tooling changes routes through
GitHub Service Agent. Validation evidence remains owned by QA / Test Agent.
