...
5. Worksheet order: directions, worked example, guided practice,
...
9. The material preserves the throughline: digital media creators make
   intentional choices that shape audience interpretation.
10. Use the smallest necessary context and avoid duplicate checks.
