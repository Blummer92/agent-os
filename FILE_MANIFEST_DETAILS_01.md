...
| `07_Agent_Tests/google-workspace-automation-engineer.tests.md` | Compliance test prompts for the Google Workspace Automation Engineer. | 45 | Workspace automation builder implementation |
...
| `CHANGELOG.md` | Agent OS changelog. | 47 | Workspace automation builder implementation |
| `FILE_MANIFEST.md` | Review inventory of Markdown files (00_Governance-04_Registry). | 84 | Workspace automation builder implementation |
